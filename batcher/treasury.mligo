...
module Utils = struct
  ...
  *)
  let atomic_swap
    ...
    let _this_h = adjust_treasury_holding this_token_name this_holder_address DECREASE this_token_holding this_treasury_holding in
    let _that_h = adjust_treasury_holding with_that_token_name with_that_holder_address DECREASE with_that_token_holding with_that_treasury_holding in
    ...
    let _t = Big_map.update (this_holder_address) (Some(this_h)) treasury in
    let _t = Big_map.update (with_that_holder_address) (Some(that_h)) treasury in
    treasury
  ...
  let redeem_all_tokens_from_treasury_holding
    ...
    let transfer_token_holding = (fun (_n,tkh : string * token_holding) -> let _ = handle_transfer treasury_vault tkh.holder tkh.token_amount in
                                                                          ()) in
